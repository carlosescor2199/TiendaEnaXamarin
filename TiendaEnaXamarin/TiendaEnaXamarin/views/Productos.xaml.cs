...
namespace TiendaEnaXamarin.views
{
    ...
    public partial class Productos : ContentPage
    {
        ...
        public async void cargar()
        {
            ...
            string content = await cl.GetStringAsync(Endpoint.url + "/productos?stock_gt=0");
        ...
        private async void toPromociones(object sender, EventArgs e)
        {
            await Navigation.PushAsync(new Promociones());
        }

        private async void toCompras(object sender, EventArgs e)
        {
